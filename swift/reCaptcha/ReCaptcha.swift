...
class ReCaptcha: UIView {
    ...
    var delegate: ReCaptchaDelegate? = nil
...
extension ReCaptcha: WKScriptMessageHandler {
    ...
    @objc func adjustSize(of wk: WKWebView) {
        let SERect = CGRect(x: self.wk!.frame.minX, y: self.wk!.frame.midY/4, width: self.wk!.frame.width, height: self.wk!.frame.height*7)
        let eightRect = CGRect(x: self.wk!.frame.minX, y: self.wk!.frame.midY/4, width: self.wk!.frame.width, height: self.wk!.frame.height*7)
        let eightPlusRect = CGRect(x: self.wk!.frame.minX, y: self.wk!.frame.midY/3, width: self.wk!.frame.width, height: self.wk!.frame.height*7)
        let XRect = CGRect(x: self.wk!.frame.minX, y: self.wk!.frame.midY/3, width: self.wk!.frame.width, height: self.wk!.frame.height*7)
